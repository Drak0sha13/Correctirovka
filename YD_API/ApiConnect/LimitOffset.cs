...
namespace YD_API.ApiConnect
{
	...
	public class LimitOffset
	{
		...
		/// <summary> Количество возвращаемых объектов (размер страницы). От 0 до 10 000. Если не указано, используется ограничение 10 000. </summary>
		[DataMember(EmitDefaultValue = false)]
		public long Limit { get; set; }

		/// <summary> Количество объектов, которое должно быть пропущено при выборке. Если не указано, подразумевается 0. </summary>
		[DataMember(EmitDefaultValue = false)]
