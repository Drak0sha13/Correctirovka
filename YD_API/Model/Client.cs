...
namespace YD_API.Model
{
    ...
    public class Client : BaseModel
    {
        ...
        /// <summary> ФИО пользователя Директа (до 255 символов). </summary>
        [DataMember(EmitDefaultValue = false)]
        public string ClientInfo { get; set; }

        /// <summary> Идентификатор страны рекламодателя из справочника регионов.
        ...
        /// <summary>Лимит овердрафта, которым рекламодатель может воспользоваться в текущий момент времени (см. раздел Отсрочка платежа помощи Директа).
        ...
        /// <summary> Представители рекламодателя (см. раздел Регистрация представителей помощи Директа).
        /// <para> Для главного представителя возвращаются все представители, для обычного представителя — только главный представитель.</para> </summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        /// <para>  SUBCLIENT — рекламодатель, являющийся клиентом агентства.</para> </summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        {
	        return $"({ClientId}) {Login} {ClientInfo}";
        }
    }
}
