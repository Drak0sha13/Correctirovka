...
namespace YD_API.Model
{
    ...
    public class KeywordClass
    {
        ...
        /// <summary> Ключевая фраза. Может содержать минус-слова. </summary>
        [DataMember(EmitDefaultValue = false)]
        public string Keyword { get; set; }

        /// <summary> Значение подстановочной переменной {param1}. Не более 255 символов. </summary>
        [DataMember(EmitDefaultValue = false)]
        public string UserParam1 { get { return userParam1; } set { if (value != null) { userParam1 = value; } } }

        string userParam1 = "", userParam2 = "";

        /// <summary> Значение подстановочной переменной {param2}. Не более 255 символов. </summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        /// <summary> Статус ключевой фразы.  </summary>
        [DataMember(EmitDefaultValue = false)]
        ...
        /// <summary> Состояние ключевой фразы. </summary>
        [DataMember(EmitDefaultValue = false)]
        public StatusEnumK State { get; set; }

        /// <summary> Продуктивность фразы и рекомендации по ее повышению. </summary>
        [DataMember(EmitDefaultValue = false)]
        public Productivity Productivity { get; set; }

        /// <summary> Статистика показов и кликов всех объявлений группы по данной фразе на поиске. </summary>
        [DataMember(EmitDefaultValue = false)]
        public Statistics StatisticsSearch { get; set; }

        /// <summary> Статистика показов и кликов всех объявлений группы по данной фразе в сетях. </summary>
        [DataMember(EmitDefaultValue = false)]
